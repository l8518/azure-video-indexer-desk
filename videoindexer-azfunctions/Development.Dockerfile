...
# Image defaults:
FROM mcr.microsoft.com/dotnet/core/sdk:2.1 as videoindexer-azfunctions-development
...
FROM videoindexer-azfunctions-development AS videoindexer-azfunctions-builder
